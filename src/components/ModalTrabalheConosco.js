      ...
      <div onClick={onClick} className='absolute top-1 right-2 text-white cursor-pointer flex items-center gap-3'><FaWindowClose size={20} color='#0F5197'/> </div>
        <div className='bg-white w-full h-full rounded-xl'>
          <div className='flex flex-col sm:flex-row w-full h-full'>
            <div className='bg-trabalheconosco h-[100px] hidden sm:block flex-none sm:flex-auto sm:h-full w-full sm:w-[45%]'>
            ...
            <div className='w-full sm:w-[55%] h-full flex items-center'>
              <div className='container mx-auto'>
                ...
                <form action='https://submit-form.com/TglMZZVb' onSubmit={onSubmitForm} className='flex flex-col gap-[20px]' target="_blank">

                <input type="hidden" name="_email.template.title" value="Formulário de Contato - Trabalhe Conosco" />
                <input type="hidden" name="_email.template.footer" value="false" />
                <input type="hidden" name="_email.from" value="Comabe - Trabalhe Conosco" />
                <input type="hidden" name="_email.subject" value="Novo Contato! - Formulário - Trabalhe Conosco" />
                <input type="hidden" name="_redirect" value={urlReturn} />
                  ...
                  <textarea name='Mensagem' placeholder='Mensagem' className='bg-[#F8F8FA] h-[140px] pl-[20px] pt-[20px] rounded-md outline-none' required>
