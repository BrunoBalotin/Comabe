  ...
  return (
    <div className='bg-white w-[340px] h-[435px] rounded-xl shadow-shadow-card pb-[30px] pt-[30px]'>
        <div className='flex flex-col items-center justify-center h-full'>
            ...
            <a target='_blank' rel='noreferrer' className='flex justify-center items-center bg-[#0F5197] hover:bg-black duration-700 px-7 py-3 w-[200px] text-[18px] text-white font-medium rounded-full cursor-pointer' href={LinkButton}>Tenho interesse</a>
        </div>
    </div>
  )
}
