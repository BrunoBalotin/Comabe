      ...
      <div className='container mx-auto'>
        <div className='flex flex-wrap xl:flex-nowrap lg:gap-[80px] xl:justify-between w-full pt-[60px] lg:pt-[100px] xl:pt-[160px]'>
          <div className='flex flex-wrap lg:flex-nowrap flex-col w-full lg:w-[20%] xl:w-[18%]'>
            <Link onClick={scrollToTop} to={'/'}> <ComabeBranco className='w-[100px] lg:w-auto'/> </Link>
        ...
        <span className='text-white lg:text-[15px] hidden lg:flex xl:text-[16px] 2xl:text-[18px] font-medium lg:w-[30%] xl:w-[30%] 2xl:w-[50%] justify-center items-center gap-[15px]'><a onClick={scrollToTop} className='flex cursor-pointer items-center gap-[15px]'>Voltar ao topo <ArrowDownFooter className='mt-[5px]'/></a> </span>
