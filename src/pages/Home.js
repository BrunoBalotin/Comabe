    ...
    <div className='w-full flex bg-gradiente-blue pb-20 lg:pb-0 lg:h-600'>
      ...
      <div className='flex flex-col gap-[20px] lg:pt-[200px] xl:pt-[250px]'>
        ...
        <div className='flex flex-col lg:flex-row gap-12 mt-14'>
          <CardBlog onClick={scrollToTop} BlogLink='/blog/bom-funcionamento-de-sua-impressora' Image="https://uploaddeimagens.com.br/images/004/041/516/full/Bom_funcionamento.png?1664451506" Title='8 Cuidados que você precisa ter para o bom funcionamento de sua impressora' Text='As impressoras facilitam muito a vida de quem trabalha constantemente com documentos físicos, seja em escritórios, setores públicos ou hospitais.'/>
