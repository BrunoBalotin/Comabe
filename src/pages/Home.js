  ...
  return (
    ...
    <div className='w-full flex bg-gradiente-blue pb-20 lg:pb-0 lg:h-600'>
      ...
      <div className='flex flex-col gap-[20px] lg:pt-[200px] xl:pt-[250px]'>
        ...
        <CardBlog onClick={scrollToTop} BlogLink='/blog/8-cuidados-que-você-precisa-ter-para-o-bom-funcionamento-de-sua-impressora' Image="https://uploaddeimagens.com.br/images/004/041/516/full/Bom_funcionamento.png?1664451506" Title='8 Cuidados que você precisa ter para o bom funcionamento de sua impressora' Text='As impressoras facilitam muito a vida de quem trabalha constantemente com documentos físicos, seja em escritórios, setores públicos ou hospitais.'/>
          <CardBlog onClick={scrollToTop} BlogLink='/blog/como-a-ufs-encontrou-documentos-perdidos-atraves-da-digitaliza%C3%A7%C3%A3o' Image="https://uploaddeimagens.com.br/images/004/031/436/full/UFS.png?1663846055" Title='Como a UFS encontrou documentos perdidos através da digitalização' Text='A Universidade Federal do Sergipe diminuiu o tempo que levava para buscar arquivos e encontrou trabalhos, documentos e peças perdidas em seu acervo físico.'/>
          <CardBlog onClick={scrollToTop} BlogLink='/blog/4-vantagens-para-secretaria-escolar' Image="https://uploaddeimagens.com.br/images/004/016/366/full/Scanner_escola_2.png?1662745614" Title='Scanner Brother: 4 vantagens para secretaria escolar' Text='As mudanças de legislação oportunizam a digitalização dos documentos escolares em instituições de ensino.'/>
