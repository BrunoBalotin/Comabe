...
function QuemSomos() {
  return (
    ...
    <div className='container mx-auto'>
      <div>
        <h2 className='text-white w-max py-3 px-6 rounded-3xl text-[18px] font-medium leading-none mb-[20px] bg-[#0088FF]'>SOBRE NÓS</h2>
        <h1 className='text-white text-[48px] font-medium leading-none mb-[20px]'>Mantemos a tradição</h1>
        <p className='text-white text-[18px] font-light w-[90%] md:w-[561px] leading-relaxed'>Desde 1967 inovando em tecnologia e soluções para ambientes de impressão e digitalização de documentos.</p>
      </div>
    </div>
    ...
    <div className='bg-[#F8F8FA]'>
      ...
      <div className='flex flex-col lg:flex-row justify-between'>
        <div className='pt-[160px] lg:w-[45%]'>
          <h2 className='text-[26px] sm:text-[36px] md:text-[36px] lg:text-[28px] xl:text-[36px] 2xl:text-[42px] text-[#343434] font-medium mb-[30px] leading-snug'>Somos especialistas em soluções para impressão e transformação digital de documentos</h2>
          <p className='text-[15px] sm:text-[16px] md:text-[16px] lg:text-[15px] xl:text-[16px] 2xl:text-[18px] font-light text-[#575757] leading-relaxed mb-[40px]'>Fornecemos soluções completas para sua empresa esquecer de vez de se preocupar com impressoras ou documentos impressos. Facilitamos ao máximo a sua experiência com os nossos serviços, para promover a sua empresa a praticidade necessária para você focar em outras áreas do seu negócio.</p>
        ...
        <div className='bg-[#ECA918] md:w-[100%] md:h-[230px] lg:w-[450px] lg:h-[500px] xl:w-[526px] xl:h-[591px] rounded-2xl sm:rounded-none sm:rounded-t-3xl flex flex-col mt-[20px] pb-[10px] sm:pb-0 pt-[20px] pl-[0px] sm:mt-[30px] md:mt-[50px] lg:mt-[160px] sm:pl-[40px] sm:pt-[30px] md:pt-[50px] lg:pt-[100px]'>
          <span className='text-white sm:text-[24px] md:text-[26px] lg:text-[20px] xl:text-[22px] 2xl:text-[24px] font-medium ml-[17px] mb-[50px]'>Números que nos orgulhamos:</span>
          <div className='flex flex-col sm:flex-col md:flex-row gap-3 lg:block'>
            <div className='flex items-center'>
              ...
              <h2 className='text-white font-medium w-full lg:text-[20px] xl:text-[22px] 2xl:text-[24px]'>+ de <span className='lg:text-[24px] xl:text-[28px] 2xl:text-[30px]'>15.000</span> Clientes </h2> 
            </div>
            <div className='flex items-center'>
              <img className='w-[60px] md:w-[70px] lg:w-auto' src={Impressora} alt='icone' />
              <h2 className='text-white font-medium w-full lg:text-[20px] xl:text-[22px] 2xl:text-[24px]'>+ de <span className='lg:text-[24px] xl:text-[28px] 2xl:text-[30px]'>50.000</span> Equipamentos </h2> 
            </div>
            <div className='flex items-center'>
              <img className='w-[60px] md:w-[70px] lg:w-auto' src={Gotas} alt='icone' />
              <h2 className='text-white font-medium w-full lg:text-[20px] xl:text-[22px] 2xl:text-[24px]'>+ de <span className='lg:text-[24px] xl:text-[28px] 2xl:text-[30px]'>1.000.000</span> Suprimentos </h2> 
            </div>
          </div>
        </div>
      </div>
    ...
    <div className='sm:h-[820px] md:h-[920px] lg:h-[620px] 2xl:h-[820px] flex items-center'>
      ...
      <div className='flex flex-col md:flex-col lg:flex-row justify-between'>
        ...
        <div className='md:w-full mt-[50px] md:mt-[50px] lg:mt-0 lg:w-[47%]'>
          <h2 className='text-[26px] sm:text-[36px] md:text-[36px] lg:text-[28px] xl:text-[36px] 2xl:text-[42px] text-[#343434] font-medium mb-[30px]'>Nosso maior desafio</h2>
          <p className='text-[15px] sm:text-[16px] md:text-[16px] lg:text-[15px] xl:text-[16px] 2xl:text-[18px] text-[#343434] font-light mb-[40px]'>Fornecer aos nossos clientes as melhores soluções em equipamentos para impressoras, gestão de documentos físicos e digitais, aluguel de equipamentos de impressão, monitoramento e gerenciamento eletrônico de documentos, e migração digital.</p>

          <span className='text-[18px] md:text-[20px] lg:text-[20px] xl:text-[22px] 2xl:text-[24px] text-[#343434] font-medium flex items-center gap-[15px]'><Check className='w-[22px] md:w-[26px] xl:w-[26px] 2xl:w-auto' /> As melhores soluções pra você</span>
          <p className='text-[15px] sm:text-[16px] md:text-[16px] lg:text-[15px] xl:text-[16px] 2xl:text-[18px] text-[#343434] font-light mt-[30px]'>Somos especialistas em proporcionar a migração digital de documentos dos nossos clientes, soluções completas de gestão de documentos físicos e transformação de materiais impressos em arquivos digitais através do business scan, o processo de digitalização de documentos acessível em poucos cliques.</p>
        </div>
      </div>
      </div>
    </div>
      ...
      <div className='container mx-auto'>
        <div className='flex flex-col-reverse md:flex-col-reverse lg:flex-row justify-between'>
          <div className='w-full mt-[50px] md:mt-0 md:w-full lg:w-[50%]'>
            <h2 className='text-[26px] sm:text-[36px] md:text-[36px] lg:text-[28px] xl:text-[36px] 2xl:text-[42px] text-[#343434] font-medium mb-[30px]'>55 Anos de comprometimento</h2>
            <p className='text-[15px] sm:text-[16px] md:text-[16px] lg:text-[15px] xl:text-[16px] 2xl:text-[18px] text-[#343434] font-light mb-[30px]'>A Comabe, ao longo dos seus 55 anos de atuação, sempre buscou levar mais tecnologia e inovação para a rotina de seus clientes, trazendo mais praticidade e eficiência na gestão das suas atividades.</p>
            <p className='text-[15px] sm:text-[16px] md:text-[16px] lg:text-[15px] xl:text-[16px] 2xl:text-[18px] text-[#343434] font-light mb-[30px]'>Todos os nossos serviços buscam entregar para os nossos clientes soluções completas que visam agilizar os seus processos e facilitar o seu dia a dia na gestão de documentos.</p>
            <p className='text-[15px] sm:text-[16px] md:text-[16px] lg:text-[15px] xl:text-[16px] 2xl:text-[18px] text-[#343434] font-light mb-[40px]'>Contamos com uma equipe qualificada, que está sempre pronta para entregar aos nossos clientes um atendimento personalizado, atendendo empresas das mais variadas áreas e de portes distintos, sempre disponibilizando soluções que visam o aumento de produtividade e eficiência nos processos de impressão.</p>
  ...
  <div className='bg-[#F8F8FA] h-[800px] flex items-center'>
    <div className='container mx-auto'>
        <div className='flex justify-between'>
          ...
          <div className='w-[40%]'>
            <h2 className='text-[26px] sm:text-[36px] md:text-[36px] lg:text-[28px] xl:text-[36px] 2xl:text-[42px] font-medium mb-[30px]'>Qualidade e tecnologia no seu negócio</h2>
            <p className='mb-[30px] text-[18px] font-light'>Conte com as melhores marcas e equipamentos do mercado.</p>
            <p className='mb-[30px] text-[18px] font-light'>Com a Comabe, você trabalha com as melhores marcas do mercado e ainda tem ganho na produtividade e redução de custos.</p>
            <p className='mb-[50px] text-[18px] font-light'>Ficou interessado? Então venha conversar com um de nossos consultores e conferir as condições especiais que preparamos para você!</p>
